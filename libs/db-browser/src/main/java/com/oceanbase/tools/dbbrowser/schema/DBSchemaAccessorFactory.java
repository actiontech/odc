...
import com.oceanbase.tools.dbbrowser.schema.hana.HanaSchemaAccessor;
...
public class DBSchemaAccessorFactory extends AbstractDBBrowserFactory<DBSchemaAccessor> {
    ...
    @Override
    public DBSchemaAccessor buildForHana() {
        return new HanaSchemaAccessor(getJdbcOperations());
    }
