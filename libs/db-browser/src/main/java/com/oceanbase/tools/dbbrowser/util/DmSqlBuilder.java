...
/**
 * SQL builder for DM (DaMeng) database. DM uses double quotes for identifier quoting (same as
 * Oracle). DM is case-insensitive by default and stores identifiers in upper case.
 */
public class DmSqlBuilder extends SqlBuilder {
