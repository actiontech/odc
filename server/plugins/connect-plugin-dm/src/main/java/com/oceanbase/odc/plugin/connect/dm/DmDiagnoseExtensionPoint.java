...
/**
 * SQL diagnose extension for DM (Dameng) database.
 * <p>
 * DM supports {@code EXPLAIN <sql>} for execution plan retrieval.
 * </p>
 *
 * @author
...
@Slf4j
@Extension
public class DmDiagnoseExtensionPoint implements SqlDiagnoseExtensionPoint {
    ...
    public SqlExplain getExplain(Statement statement, @NonNull String sql) throws SQLException {
        ...
        try {
            ...
            log.warn("Failed to get explain plan from DM", e);
