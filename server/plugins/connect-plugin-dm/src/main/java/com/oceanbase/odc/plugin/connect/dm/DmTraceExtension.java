...
/**
 * Trace extension for DM (Dameng) database.
 * <p>
 * DM does not support SQL trace, so all methods return default empty values.
 * </p>
 *
 * @author
...
@Slf4j
@Extension
public class DmTraceExtension implements TraceExtensionPoint {
