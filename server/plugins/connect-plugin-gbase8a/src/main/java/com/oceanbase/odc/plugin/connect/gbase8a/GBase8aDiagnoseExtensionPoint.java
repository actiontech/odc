...
/**
 * SQL diagnose extension for GBase-8a (EXPLAIN when available).
 */
@Slf4j
@Extension
public class GBase8aDiagnoseExtensionPoint implements SqlDiagnoseExtensionPoint {
    ...
    public SqlExplain getExplain(Statement statement, @NonNull String sql) throws SQLException {
        ...
        try {
            ...
            log.warn("Failed to get explain plan from GBase-8a", e);
    ...
    public SqlExplain getPhysicalPlanBySqlId(Connection connection, @NonNull String sqlId) {
        throw new UnsupportedOperationException("Not supported for GBase-8a");
    }
