...
@Slf4j
@Extension
public class TiDBConnectionExtension extends MySQLConnectionExtension {
    private final String MIN_VERSION_SUPPORTED = "5.0.0";
    ...
    public TestResult test(String jdbcUrl, Properties properties, int queryTimeout,
        ...
        try (Connection connection = DriverManager.getConnection(jdbcUrl, properties)) {
            TiDBInformationExtension informationExtension = new TiDBInformationExtension();
