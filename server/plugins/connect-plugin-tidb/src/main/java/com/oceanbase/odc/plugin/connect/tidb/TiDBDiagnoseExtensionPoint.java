...
@Slf4j
@Extension
public class TiDBDiagnoseExtensionPoint extends MySQLDiagnoseExtensionPoint implements SqlDiagnoseExtensionPoint {

    @Override
    public SqlExplain getPhysicalPlanBySqlId(Connection connection, @NonNull String sqlId) throws SQLException {
        throw new UnsupportedOperationException("Not supported for tidb mode");
    }
