 ...
 */
package com.oceanbase.odc.plugin.schema.dm.utils;

import java.sql.Connection;

import com.oceanbase.odc.common.util.JdbcOperationsUtil;
import com.oceanbase.odc.core.shared.constant.DialectType;
import com.oceanbase.odc.plugin.connect.dm.DmInformationExtension;
...
/**
 * Utility class for creating db-browser accessors and editors for DM database.
 *
 * @author
...
public class DBAccessorUtil {
    ...
    public static String getDbVersion(Connection connection) {
        return new DmInformationExtension().getDBVersion(connection);
    }
