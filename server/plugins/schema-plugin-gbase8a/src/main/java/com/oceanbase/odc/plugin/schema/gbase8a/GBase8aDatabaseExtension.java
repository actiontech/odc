...
/**
 * Lists databases for datasource sync / SessionDropdown. Required for {@code POST
 * .../datasources/{id}/sync} on GBASE_8A.
 */
@Extension
public class GBase8aDatabaseExtension extends OBMySQLDatabaseExtension {
