...
/**
 * SAP HANA function extension for function metadata retrieval and DDL template generation.
 *
 * @since ODC_release_4.3.4
 */
@Extension
public class HanaFunctionExtension extends OBMySQLFunctionExtension {
