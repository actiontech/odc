...
/**
 * SAP HANA procedure extension for procedure metadata retrieval and DDL template generation.
 *
 * @since ODC_release_4.3.4
 */
@Extension
public class HanaProcedureExtension extends OBMySQLProcedureExtension {
