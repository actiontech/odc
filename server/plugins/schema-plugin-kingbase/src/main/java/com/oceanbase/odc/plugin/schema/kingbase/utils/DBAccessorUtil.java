 ...
 */
package com.oceanbase.odc.plugin.schema.kingbase.utils;

import java.sql.Connection;

import com.oceanbase.odc.common.util.JdbcOperationsUtil;
import com.oceanbase.odc.core.shared.constant.DialectType;
import com.oceanbase.odc.plugin.connect.kingbase.KingBaseInformationExtension;
...
/**
 * KingBase oracle mode: db-browser has no KINGBASE type; reuse Oracle accessors/editors.
 */
public class DBAccessorUtil {

    public static String getDbVersion(Connection connection) {
        return new KingBaseInformationExtension().getDBVersion(connection);
    }
