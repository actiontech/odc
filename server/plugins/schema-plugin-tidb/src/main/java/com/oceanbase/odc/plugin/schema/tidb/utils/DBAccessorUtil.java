 ...
 */
package com.oceanbase.odc.plugin.schema.tidb.utils;

import java.sql.Connection;

import com.oceanbase.odc.common.util.JdbcOperationsUtil;
import com.oceanbase.odc.core.shared.constant.DialectType;
import com.oceanbase.odc.plugin.connect.tidb.TiDBInformationExtension;
...
public class DBAccessorUtil {
    ...
    public static String getDbVersion(Connection connection) {
        return new TiDBInformationExtension().getDBVersion(connection);
    }
